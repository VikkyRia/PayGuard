...
import { ArrowLeft, Eye, EyeOff, User, ShoppingCart } from "lucide-react";
...
const Auth = () => {
  ...
  const [role, setRole] = useState("seller" as "buyer" | "seller");
  ...
  const handleSubmit = async (e: React.SubmitEvent<HTMLFormElement>) => {
    ...
    if (isLogin) {
      ...
      if (error) {
        ...
        const redirect =
          userType === "buyer" ? "/buyer/dashboard" : "/dashboard";
      ...
      if (error) {
        ...
        resetForm(); // Clear the sensitive data (password, etc)
        setIsLogin(true); // Switch the UI to the Login form
      }
    }
    setLoading(false);
  };
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card rounded-2xl shadow-elevated border border-border p-8">
          ...
          {forgotMode ? (
            ...
            <>
              <h1 className="font-display text-xl font-extrabold text-foreground mb-1">
